...
public class CalculadoraDeDescontos {
	...
	public BigDecimal calcularDesconto(Orcamento orcamento) {
		...
		/**
		 * Se esse Orçamento tiver um desconto válido aplique, 
		 * logo preciso passar por todos os tipos de descontos
		 * e validar se ele é aplicável ou não. E se não for aplicavel
		 * vai para o próximo desconto disponivel, 
