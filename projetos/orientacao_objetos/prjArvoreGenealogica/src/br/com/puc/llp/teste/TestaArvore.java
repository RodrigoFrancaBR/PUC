...
public class TestaArvore {
	...
	public static void main(String[] args) {
		...
		if (donaNeves instanceof Mulher) {
			...
			System.out.println(
					"IMC: " + calcularIMC + " Classificação: " + classificaIMC + " da pessoa " + donaNeves.getNome());
		}
	...
	private static void exibirParentesco(Pessoa p1, Pessoa p2) {
		...
		if (parentesco == Parentesco.MESMA_PESSOA && parentesco2 == Parentesco.MESMA_PESSOA) {
			System.out.println(p1.getNome() + " é a mesma pessoa que " + p2.getNome() + " e " + p2.getNome()
					+ " é a mesma pessoa que " + p1.getNome());
		}
