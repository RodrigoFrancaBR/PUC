...
public class Pessoa {
	 ...
	 *             Caso algum dos parametros não seja informado
	 */
	 ...
	 * 
	 * @param pessoa
	 *            com quem vc teve o filho(s)
	 * @param filhos
	 *            um ou mais filhos com a pessoa acima
	 */
	...
	/**
	 * Valida se uma pessoa eh pai ou mae da outra Se eu tiver pai e o meu pai
	 * for igual a pessoa ou se eu tiver mae e minha mae for igual a pessoa
	 * 
	 * @param pessoa
	 * @return true ou false
	 */
	private boolean eMeuPaiOuMae(Pessoa pessoa) {
		return this.getPai() != null && this.getPai().equals(pessoa)
				|| this.getMae() != null && this.getMae().equals(pessoa);
	}
	...
	private boolean eMeuMaridoOuEsposa(Pessoa pessoa) {
		return this.conjuge != null && this.conjuge.equals(pessoa) && pessoa.conjuge != null
				&& pessoa.conjuge.equals(this);
	}

	/**
	 * valida se uma pessoa eh meu avô ou avó Se eu tiver pai e o meu pai tiver
	 * um pai e o pai do meu pai for igual a pessoa ou se eu tiver mae e minha
	 * mae tiver mae e a mae da minha mae for igual a pessoa
	 * 
	 * @param pessoa
	 * @return true ou false
	 */
	private boolean eMeuAvoOuMinhaAvo(Pessoa pessoa) {
		return this.getPai() != null && this.getPai().eMeuPaiOuMae(pessoa)
				|| this.getMae() != null && this.getMae().eMeuPaiOuMae(pessoa);
	}
	...
	/**
	 * Valida se uma pessoa e meu tio ou tia Se eu tiver pai e o meu pai for
	 * irmao da pessoa ou se eu tiver mae e minha mae for irmao da pessoa
	 * 
	 * @param pessoa
	 * @return true ou false
	 */
	private boolean eMeuTioOuTia(Pessoa pessoa) {
		return this.getPai() != null && this.getPai().somosIrmaos(pessoa)
				|| this.getMae() != null && this.getMae().somosIrmaos(pessoa);
	}
	...
	private boolean eMeuSobrinhoOuSobrinha(Pessoa pessoa) {
		...
		return (this.somosIrmaos(pessoa.getPai()) || this.somosIrmaos(pessoa.getMae()));
	}

	/**
	 * Valida se uma pessoa eh meu irmao Se eu tiver pai e o meu pai for igual
	 * ao pai da pessoa ou se eu tiver mae e minha mae for igual a mae da pessoa
	 * 
	 * @param pessoa
	 * @return true ou false
	 */
	private boolean somosIrmaos(Pessoa pessoa) {
		...
		return this.getPai() != null && pessoa.getPai() != null && this.getPai().equals(pessoa.getPai())
				|| this.getMae() != null && pessoa.getMae() != null && this.getMae().equals(pessoa.getMae());

	}

	/**
	 * Valida se uma pessoa eh meu primo Se eu tiver pai e o meu pai for irmao
	 * do pai da pessoa(pai ou mae) ou se eu tiver mae e minha mae for irma da
	 * mae da pessoa (pai ou mae)
	 * 
	 * @param pessoa
	 * @return true ou false
	 */
	private boolean somosPrimos(Pessoa pessoa) {
		...
		if (this.getPai() != null && pessoa.getPai() != null) {
			...
			boolean somosIrmaosPartePai = this.getPai().somosIrmaos(pessoa.getPai());

			boolean somosIrmaosParteMae = this.getPai().somosIrmaos(pessoa.getMae());
		...
		if (this.getMae() != null && pessoa.getMae() != null) {
			...
			boolean somosIrmaosParteMae = this.getMae().somosIrmaos(pessoa.getMae());

			boolean somosIrmaosPartePai = this.getMae().somosIrmaos(pessoa.getPai());
